...
class AllTheFeelings extends ConsumerStatefulWidget {
  const AllTheFeelings({
    super.key,
    this.contents,
  });
  final List<Content>? contents;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AllTheFeelingsState();
}

class _AllTheFeelingsState extends ConsumerState<AllTheFeelings> {
  @override
