...
class IrresistibleSingAlongs extends ConsumerStatefulWidget {
  const IrresistibleSingAlongs({
    super.key,
    this.contents,
  });
  final List<Content>? contents;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _IrresistibleSingAlongsState();
}

class _IrresistibleSingAlongsState extends ConsumerState<IrresistibleSingAlongs> {
  @override
