...
class NewReleases extends ConsumerStatefulWidget {
  const NewReleases({
    super.key,
    this.contents,
  });
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _NewReleasesState();
}

class _NewReleasesState extends ConsumerState<NewReleases> {
  @override
