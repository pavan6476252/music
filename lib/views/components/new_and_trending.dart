...
class NewAndTrending extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _NewAndTrendingState();
}

class _NewAndTrendingState extends ConsumerState<NewAndTrending> {
  @override
