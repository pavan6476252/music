...
class TodayBigHits extends ConsumerStatefulWidget {
  const TodayBigHits({
    super.key,
    this.contents,
  });
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _TodayBigHitsState();
}

class _TodayBigHitsState extends ConsumerState<TodayBigHits> {
  @override
