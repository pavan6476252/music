...
class FeelGoodFavorites extends ConsumerStatefulWidget {
  const FeelGoodFavorites({
    super.key,
    this.contents,
  });
  final List<Content>? contents;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FeelGoodFavoritesState();
}

class _FeelGoodFavoritesState extends ConsumerState<FeelGoodFavorites> {
  @override
